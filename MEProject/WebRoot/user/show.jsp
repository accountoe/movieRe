		...
		<div id="header_top">
			<div id="top_1200">
				...
				<ul>
					...
					<li><a href="mine/${name }-0" >个人中心</a></li>
					<li><a href="showCart/${name }">我的购物车</a></li>
					<li><strong>您好，${name }</strong></li>
			...
			<div id="cate_main">
						...
						<div class="sub_cate_pop">
							<ul>
								<li>
									...
									<a href="showDetails/1-${name }">感冒灵颗粒</a>
									<span class="devider">|</span>
									<a href="showDetails/2-${name }">布洛芬胶囊</a><br />
									<span class="devider">|</span>
									<a href="showDetails/3-${name }">复方感冒灵</a>
									<span class="devider">|</span>
									<a href="showDetails/4-${name }">感冒咳嗽灵</a><br />
									<span class="devider">|</span>
									<a href="showDetails/5-${name }">苏黄止咳灵</a>
									<span class="devider">|</span>
									<a href="showDetails/6-${name }">鲜竹沥液</a>
								</li>
								<li>
									<a href="medicineList/0">止咳化痰&gt;</a><br />
								    <span class="devider">|</span>
									<a href="showDetails/8-${name }">金银花颗粒 </a>
									<span class="devider">|</span>
									<a href="showDetails/9-${name }">防风通圣丸</a><br />
									<span class="devider">|</span>
									<a href="showDetails/10-${name }">感冒灵胶囊</a>
									<span class="devider">|</span>
									<a href="showDetails/11-${name }">维生素B2片</a>
								</li>
								<li>
									<a href="medicineList/0">祛风通窍&gt;</a><br />
									<span class="devider">|</span>
									<a href="showDetails/4-${name }">苏黄止咳</a>
									<span class="devider">|</span>
									<a href="showDetails/6-${name }">鲜竹沥液</a><br />
									<span class="devider">|</span>
									<a href="showDetails/14-${name }">冬凌草片</a>
								</li>
								<li>
									<a href="#">风邪犯肺&gt;</a><br />
									<span class="devider">|</span>
									<a href="showDetails/7-${name }">辛芩颗粒</a>
								</li>
							</ul>
						</div>
						<div class="ins_img">
				...
				<div class="cate_line" >
					...
					<div class="sub_cate">	
						...
						<div class="ins_img">
							<dl>
							    <dt><a href="#"><img src="../img/31.jpg"/></a></dt>
								<dd></dd>
							</dl>
							<dl>
						        <dt><a href="#"><img src="../img/32.jpg"/></a></dt>
						        <dd></dd>       
							</dl>		
						</div>
						<div class="x">X</div>
				...
				<div class="cate_line" >
					...
					<div class="sub_cate">	
						...
						<div class="ins_img">
							<dl>
							    <dt><a href="#"><img src="../img/41.jpg"/></a></dt>
								<dd></dd>
							</dl>
							<dl>
						        <dt><a href="#"><img src="../img/42.jpg"/></a></dt>
						        <dd></dd>       
							</dl>		
						</div>
						<div class="x">X</div>
		    	...
		    	<div class="ct-prd">
		    		<ul>
		    		  <c:forEach items="${ganmao }" var="ganmao">
		    			<li>
		    				<dl>
		    					<dt><a href="showDetails/${ganmao.id }-${name }"><img src="../img/${ganmao.id }.jpg"/></a></dt>
		    					<dd><a href="showDetails/${ganmao.id }-${name }">${ganmao.name }&nbsp;${ganmao.number }</a></dd>
		    				</dl>
		    				<b>￥${ganmao.price }</b>
		    			</li>
		    		  </c:forEach>
		    ...
		    <div class="ct-r">
		    	<div class="ct-prd">
		    		<ul>
		    			...
		    			<li>
		    				<dl>
		    					<dt><a href="showDetails/${kuiyang.id }-${name }"><img src="../img/${kuiyang.id }.jpg"/></a></dt>
		    					<dd><a href="showDetails/${kuiyang.id }-${name }">${kuiyang.name }&nbsp;${kuiyang.number }</a></dd>
		    				</dl>
		    				<b>￥${kuiyang.price }</b>
		    			</li>
		    		  </c:forEach>
		    ...
		    <div class="ct-r">
		    	<div class="ct-prd">
		    		<ul>
		    			...
		    			<li>
		    				<dl>
		    					<dt><a href="showDetails/${pifu.id }-${name }"></a><img src="../img/${pifu.id }.jpg"/></dt>
		    					<dd><a href="showDetails/${pifu.id }-${name }">${pifu.name }&nbsp;${pifu.number }</a></dd>
		    				</dl>
		    				<b>￥${pifu.price }</b>
		    			</li>
		    		  </c:forEach>
		    ...
		    <div class="ct-r">
		    	<div class="ct-prd">
		    		<ul>
		    			...
		    			<li>
		    				<dl>
		    					<dt><a href="showDetails/${shanghuo.id }-${name }"></a><img src="../img/${shanghuo.id }.jpg"/></dt>
		    					<dd><a href="showDetails/${shanghuo.id }-${name }">${shanghuo.name }&nbsp;${shanghuo.number }</a></dd>
		    				</dl>
		    				<b>￥${shanghuo.price }</b>
		    			</li>
		    		    </c:forEach>
		    ...
		    <div class="ct-r">
		    	<div class="ct-prd">
		    		<ul>
		    			...
		    			<li>
		    				<dl>
		    					<dt><a href="showDetails/${changwei.id }-${name }"></a><img src="../img/${changwei.id }.jpg"/></dt>
		    					<dd><a href="showDetails/${changwei.id }-${name }">${changwei.name }&nbsp;${changwei.number }</a></dd>
		    				</dl>
		    				<b>￥${changwei.price }</b>
		    			</li>
		    		    </c:forEach>
